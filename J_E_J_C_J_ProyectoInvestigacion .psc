...
Funcion divison_por_resta()
	definir n1,n2,cont,resultado como real 
	...
	cont<-0
	resultado<-n1
	mientras resultado-n2 >= 0 Hacer
		resultado<-resultado - n2
		escribir ( resultado + n2 )," - ", n2, " = ",resultado
		cont<-cont+1
	FinMientras
	escribir " El resultado de la divison es ", cont
FinFuncion
//Numeros 3
Funcion multiplicacion_por_suma()
	...
	Para i<-1 Hasta n2 Con Paso 1 Hacer
		suma<-suma+n1
		escribir (suma-n1), "+", n1, "=", suma
	Fin Para
	escribir "La multiplicacion de ",N1, " X ", N2, " = ", suma
FinFuncion 
//Numeros 4
...
Funcion LONGITUD_FRASES()
	...
	ESCRIBIR "Ingresa una frase"
	LEER FRASE1
	ESCRIBIR "Ingresa la segundas frase"
	LEER FRASE2
	TAM1=Longitud(FRASE1)
	TAM2=Longitud(FRASE2)
	SI TAM1 > TAM2 Entonces
		ESCRIBIR FRASE1, " Es la frase con mayor longitud"
	SiNo
	SI TAM1 < TAM2 Entonces
		ESCRIBIR FRASE2 , " Es la frase con mayor longitud"
	FinSi
	FinSi
FinFuncion
//Cadenas 5
...
Funcion DIG()
	...
	para x=0 Hasta lon-1 Hacer
		...
		FinSi
	FinPara
	Escribir "La cantidad de digitos ingresados es: ",cont
	Escribir "La cantidad de vocales es: ",cont1
	Escribir "La cantidad de consonantes es: ",cont2
FinFuncion
//Cadenas 7
Funcion PALABRAS()
